    ...
    with open('bank_data.csv', 'r') as csv_file:
        ...
        for row in reader:
            ...
            try:
                ...
                valid_record = False
                error_message += 'Not a valid transaction amount. Non-numeric transaction amount.'
            ...
            if valid_record:
                ...
                # Collect and store invalid records
...
print("\nREJECTED RECORDS\n================")
for record, message in rejected_records:
    print("REJECTED:", record, message)
